...
class TestBlackwellTMALoadFusion(TestCase):
    ...
    def test_blackwell_mm_sigmoid_epilogue_tma_load(
        ...
        FileCheck().check("triton_tem_fused_mm").check("tma_descriptor").check(".load([").run(code[0])
    ...
    def test_blackwell_mm_scale_bias_epilogue_tma_load(
        ...
        FileCheck().check("triton_tem_fused").check("tma_descriptor").check(".load([").run(code[0])
